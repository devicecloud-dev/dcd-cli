...
- Run a single test: `npx mocha --require ts-node/register test/integration/cloud.integration.test.ts --timeout 60000` (requires the mock API already running on its expected port).
